...
Após o processo de transformação do arquivo .gb em um arquivo tabular, eu realizei a etapa restante de formatação das informações de forma manual. Inseri a tabela no LibreOffice Calc (TALEZ o excell sirva...) e removi as sequências que não continham informação de País de coleta na entrada do genbank; em seguida, 
