...
```{r, out.width='90%', fig.align='center', fig.cap="Códon (destacado pela linha horizontal vermelha) de parada em 3 isolados do Brasil",message=FALSE, warning=FALSE, echo=F}
